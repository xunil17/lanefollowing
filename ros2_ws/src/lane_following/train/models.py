...
def build_openpilot_model():
    ...
    intermediary_outputs = Concatenate(name='outputs')([path, left_lane, right_lane, lead, dense_1, snpe_pleaser2, add_3])

    dense_1_final = Dense(100, name='dense_1_final')(intermediary_outputs)
    ...
    model = Model(inputs=[vision_input, desire, rnn_state], outputs=dense_4_final, name='driving_model')
